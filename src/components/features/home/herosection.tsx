...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="flex min-h-[calc(100vh-4rem)] flex-col items-start justify-center px-6 sm:px-12"
    >
      <div className="mx-auto w-full max-w-6xl">
        ...
        <p className="mt-6 max-w-xl text-base text-slate-400 sm:text-lg">
          {/* TODO: 1–2 sentences on what you build and what you're looking for
              e.g. "I build clean, performant web apps end-to-end — from React
              front ends to the APIs behind them. Open to new opportunities." */}
